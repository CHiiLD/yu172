...
| 能                                        | 会                                        |
| ---------------------------------------- | ---------------------------------------- |
| 가능을 표현, 문장 끝에 단정적인 말투 **的**와 사용할 수 없다.<br>`他能来。*他能来的。` | 가능을 표현, **的**와 사용 가능<br>`他会来。 他会来的。`     |
| **주관**적으로 어떠한 능력의 소유를 표현<br>`他能开车。 她能弹钢琴。` | **객관**적으로 어떠한 능력의 소유를 표현<br>`他会开车。   她会弹钢琴。` |
| 비교적 **높은 수준**의 능력의 소유를 표현<br>            | **처음 습득**한 어떠한 능력의 소유를 표현<br>            |
| 어떠한 능력의 **회복**을 표현<br>                   | 사물의 필연적인 발전을 추측할 때<br>                   |
| 어떠한 일의 **능숙**을 표현<br>                    | 어떠한 일의 **능숙**을 표현<br>                    |
| 사물의 어떠한 **기능**이나 **용도**를 가지고 있음을 표현할 수 있다.<br> | 사물의 어떠한 기능이나 용도를 가지고 있음을 표현할 수 없다.<br>   |
| **조건이 부합**됨을 나타낼 때 사용 가능<br>             | 조건이 부함됨을 나타낼 때 사용 불가<br>                 |
